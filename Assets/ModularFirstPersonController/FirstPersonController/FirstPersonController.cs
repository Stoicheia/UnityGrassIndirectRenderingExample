...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void CheckGround()
    {
        ...
        float distance = .75f * transform.localScale.x;
    ...
    public void Jump(float forceModifier = 1)
    {
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.sprintDuration = EditorGUILayout.Slider(new GUIContent("Sprint Duration", "Determines how long the player can sprint while unlimited sprint is disabled."), fpc.sprintDuration, 1f, 200f);
