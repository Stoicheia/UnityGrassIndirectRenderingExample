...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else if (requestForceJump.HasValue)
        {
            Jump(requestForceJump.Value, true);
            requestForceJump = null;
        }
    ...
    {
        if (forceJumpCooldownCounter < forceJumpCooldownFrames) return;
        requestForceJump = modifier;
        forceJumpCooldownCounter = 0;
    }
